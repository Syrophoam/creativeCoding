...
out of bounds so it was hard to find errors. I would like to make one that converts an image into the same ASCII style.

3. mondiron inspired rectangles (p5.js) - week 2
...
its not immeditaly obvious what it's doing until you move the mouse. I would like to colour the rectangles like mondrion.

   
5. filtered noise (p5.js) - week 3
...
to implement DSP algorithms in images because of how mathmatically perfect it looks. I could also implement other
filters such as a high pass or band pass.

   
7. JPEG compression emulator (touchdesigner) - week 7
  jpeg.10.toe
...
A true JPEG compressor would be intresting becuase you would have more control over how the image is reconstructed.

9. tiled feedback (touchdesigner) - week 8
   tile.toe
...
it to a low quality GIF which gives it a nice pixilated effect. The colours start off nicely but a development of this would involve a proper colour pallete

   
11. spikey ball (touchdesigner) - week 11
...
which created the effect where it goes in and out of itself. I still only scratched the surface, I would like to be able to use deform to make more intresting
shapes.
